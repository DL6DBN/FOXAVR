...
'plus to keying codes MO and MO- for permanent beacons
...
Txoff:
  Temp = Second Mod Ledflash
  If Temp = 0 Then                                          'ledflash time reached?
    Reset Ledport                                           'yes, LED one second on
  Else
    Set Ledport                                             'no, LED off
  End If
Return
...
Data "ww.wldd6nbd. ec( )0270"                               'copyright info